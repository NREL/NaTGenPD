...
- Delete the contents of `source/NaTGenPD`.
- Run `sphinx-apidoc -o source/NaTGenPD ..` from the `docs` folder.
- Compare `source/NaTGenPD/modules.rst` to `source/NaTGenPD.rst`.

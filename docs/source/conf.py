...
project = 'NaTGenPD'
copyright = '2019, Michael Rossol, Grant Buster'
...
latex_documents = [
    (master_doc, 'NaTGenPD.tex', 'NaTGenPD Documentation',
...
man_pages = [
    (master_doc, 'NaTGenPD', 'NaTGenPD Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NaTGenPD', 'NaTGenPD Documentation',
     author, 'NaTGenPD', 'One line description of project.',
     'Miscellaneous'),
]
